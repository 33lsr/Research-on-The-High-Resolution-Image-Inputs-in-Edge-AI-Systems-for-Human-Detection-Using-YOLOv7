...
parser.add_argument('--det_json', default='onegt/oneprediction.json', type=str,
                    help='inference detection json file path')
parser.add_argument('--gt_json', default='onegt/one.json', type=str,
                    help='ground truth json file path')
parser.add_argument('--classes', default=('person'), type=tuple,
